...
class UserPhotos extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get(`/photosOfUser/${userId}`)
      ...
      .catch(err => console.error("user photos error", err));
  ...
  componentDidUpdate(prevProps) {
    ...
    axios.get(`/photosOfUser/${userId}`)
      ...
      .catch((err) => console.error("fetching updated user photos err:", err));

    axios.get(`/user/${userId}`)
      .then((response) => {
        this.setState({ user: response.data });
      })
      .catch((err) => console.error("fetching updated user info err:", err));
    }
  }
  render() {
